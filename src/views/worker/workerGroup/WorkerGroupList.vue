<template>
  <div>
    ...
    <!--字典弹窗-->
    <WorkerGroupModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="worker-workerGroup" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import WorkerGroupModal from './components/WorkerGroupModal.vue';
  import {columns,searchFormSchema} from './WorkerGroup.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteWorkerGroup, batchDeleteWorkerGroup, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './WorkerGroup.api';
  ...
  async function handleDelete(record) {
    await deleteWorkerGroup({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteWorkerGroup({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
