<template>
  <div>
    ...
    <!--字典弹窗-->
    <BaseMaterialTypeModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="base-baseMaterialType" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import BaseMaterialTypeModal from './components/BaseMaterialTypeModal.vue';
  import {columns,searchFormSchema} from './BaseMaterialType.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteBaseMaterialType, batchDeleteBaseMaterialType, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './BaseMaterialType.api';
  ...
  async function handleDelete(record) {
    await deleteBaseMaterialType({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteBaseMaterialType({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
