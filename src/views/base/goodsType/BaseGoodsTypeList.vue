<template>
  <div>
    ...
    <!--字典弹窗-->
    <BaseGoodsTypeModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="base-baseGoodsType" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import BaseGoodsTypeModal from './components/BaseGoodsTypeModal.vue';
  import {columns,searchFormSchema} from './BaseGoodsType.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteBaseGoodsType, batchDeleteBaseGoodsType, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './BaseGoodsType.api';
  ...
  async function handleDelete(record) {
    await deleteBaseGoodsType({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteBaseGoodsType({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
