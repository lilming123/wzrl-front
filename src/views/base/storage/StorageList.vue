<template>
  <div>
    ...
    <!--字典弹窗-->
    <StorageModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="base-storage" setup>
  //ts语法
  ...
  import {list, deleteStorage, batchDeleteStorage, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './Storage.api';
  ...
  async function handleDelete(record) {
    await deleteStorage({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteStorage({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
